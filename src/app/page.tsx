...
export default async function HomePage() {
  ...
  return <>
    <section className="luxury-hero relative isolate min-h-[calc(100svh-80px)] overflow-hidden bg-[#07110f] text-white">
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100svh-80px)] w-[min(1500px,calc(100%-40px))] flex-col justify-between py-10 md:py-14">
        ...
        <div className="grid items-end gap-10 pb-8 pt-14 lg:grid-cols-[minmax(0,0.92fr)_minmax(560px,720px)] xl:gap-16">
    ...
    <section id="story" className="relative isolate overflow-hidden border-b border-[#d8d5c9] bg-[#f1f0ea] px-4 py-24 md:px-8 md:py-40">
      <div className="pointer-events-none absolute inset-x-0 top-0 h-24 bg-gradient-to-b from-white/10 to-transparent" />
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-[#eaf4f1] to-transparent" />
    ...
    <section className="relative isolate overflow-hidden border-t border-[#d6e4df] bg-[#fbfdfc] py-24 md:py-36"><div className="pointer-events-none absolute inset-x-0 top-0 h-20 bg-gradient-to-b from-[#eaf4f1] to-transparent" /><div className="pointer-events-none absolute inset-x-0 bottom-0 h-20 bg-gradient-to-t from-[#07110f]/8 to-transparent" /><div className="container-shell relative">
